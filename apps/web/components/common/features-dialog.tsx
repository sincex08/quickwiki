 ...
 * 最近更新：2026-09-16（笔记支持手动调整展示顺序：桌面拖动 / 手机长按拖动 / 拖到笔记本改分类 / 菜单上移下移 / 恢复默认顺序；
 ...
 * 上一版 2026-09-15：侧边栏改为「笔记本 → 笔记」树状导航，桌面端列表栏并入侧栏；
...
const FEATURE_GROUPS: FeatureGroup[] = [
  ...
  },
  {
    ...
    items: [
      "PWA：可安装到桌面/主屏，离线可用",
      "响应式：桌面双栏（树状导航 + 编辑器）/ 手机单栏（底部导航 + 抽屉侧边栏 + 列表）",
